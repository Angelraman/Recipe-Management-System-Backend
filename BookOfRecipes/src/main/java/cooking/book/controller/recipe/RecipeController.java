...
public class RecipeController {
    ...
    public List<Recipe> getAllByName(@PathVariable String term){
    	List<Recipe> recipelist= recipeRepository.findAllByRecipeNameContainingIgnoreCase(term);
    	if(recipelist.isEmpty()) {
    		throw new DetailsNotFoundException("Recipe with the term "+term+" Not Found");
    	}
    	return recipelist;
    }
